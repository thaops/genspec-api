...
export class EditModeHandler {
  ...
  private buildPrompt(
    ...
    return [
      ...
      '',
      'QUY TẮC CÔNG THỨC EXCEL:',
      '- upsert_takeoff: dùng field "formula" thay vì hardcode "quantity" (vd formula:"5*3.14*2" → AI không điền quantity).',
      '- update_cells: newValue có thể là chuỗi bắt đầu bằng "=" để tạo công thức (vd "=A2*B2/1000").',
      '- KHÔNG điền số cứng khi giá trị là tích/thương của ô khác — phải dùng công thức.',
      '',
      'CẤU TRÚC WORKBOOK HIỆN TẠI:',
